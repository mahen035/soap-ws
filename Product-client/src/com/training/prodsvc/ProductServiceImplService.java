 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://prodsvc.training.com", wsdlLocation = "http://localhost:8282/product-webservice/services/ProductServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8282/product-webservice/services/ProductServiceImpl?wsdl");
